    ...
    <section className="px-4 py-24 sm:px-6 lg:px-10">
      <div className="mx-auto w-full max-w-[1600px]">
        <motion.div
          ...
          className="relative overflow-hidden rounded-[36px] border border-slate-200 bg-[linear-gradient(135deg,rgba(59,130,246,0.12),rgba(99,102,241,0.10),rgba(6,182,212,0.10))] p-[1px] dark:border-white/10 dark:bg-[linear-gradient(135deg,rgba(59,130,246,0.18),rgba(99,102,241,0.14),rgba(6,182,212,0.14))]"
        >
          <div className="relative overflow-hidden rounded-[35px] bg-white/95 px-6 py-16 text-center sm:px-10 dark:bg-[#0E1526]/96">
